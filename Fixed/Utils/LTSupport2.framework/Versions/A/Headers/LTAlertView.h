...
+(id)alertWithTitle:(NSString*)atitle secureInputPlaceholder:(NSString*)inputPlaceholder;
-(id)initWithTitle:(NSString *)atitle secureInputPlaceholder:(NSString*)inputPlaceholder;
