...
/* Misc. */
#define LT_UNUSED(statement) { statement = statement; }
...
#define LT_NSSTRING_IS_EMPTY( String ) ( String == (NSString*)[NSNull null] || String.length == 0 )
#define LT_NSSTRING_OR_PLACEHOLDER( String, Placeholder ) ( ( String != (NSString*)[NSNull null] && String.length > 0 ) ? String : Placeholder )

/* Arrays */
#define LT_NSARRAY_IS_EMPTY( Array ) ( (NSNull*)Array == [NSNull null] || [Array count] == 0 )
...
#define LT_UIEDGEINSETS_TO_NSSTRING( EdgeInsets ) [NSString stringWithFormat:@"<UIEdgeInsets: %.2f, %.2f * %.2f, %.2f>", EdgeInsets.left, EdgeInsets.top, EdgeInsets.right, EdgeInsets.bottom]
