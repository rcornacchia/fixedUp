                 ...
                 menuController:(UIViewController*)menuController;
{
 ...
 //       _menuWidth = JDSideMenuDefaultMenuWidth;
        _menuWidth = menuController.view.frame.size.width;
...
- (void)addMenuControllerView;
{
    if (self.menuController.view.superview == nil) {
        ...
        CGRectDivide(self.view.bounds, &menuFrame, &restFrame, self.menuController.view.frame.size.width, CGRectMinXEdge);
